  ...
  return (
    <section className="pt-10 relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-20">
        ...
        >
          <Link to="/projects">
            <button className="bg-primary-500 text-black px-8 py-3 font-medium transition-all duration-300 transform hover:scale-105">
              View My Projects
            </button>
          </Link>
          <Link to="/contact">
            <button className="border border-gray-400 hover:border-primary-500 text-gray-300 hover:text-primary-500 px-8 py-3  font-medium transition-all duration-300">
              Contact Me
            </button>
          </Link>
        </motion.div>
